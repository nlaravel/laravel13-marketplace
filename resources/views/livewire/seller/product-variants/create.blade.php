    ...
    <div class="mx-auto max-w-7xl p-4 sm:p-6 lg:p-8">
        ...
        <div class="mb-8 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-start gap-3">
                <div class="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-400">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                        Add a new SKU and pricing configuration for this product.
                    </p>
                </div>
            </div>
                ...
                <form wire:submit="save">
                    ...
                    <div class="mb-6 rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                        <div class="border-b border-slate-200 px-6 py-5 dark:border-slate-800">
                            ...
                            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                The product this variant will belong to.
                            </p>
                        </div>
                    ...
                    <div class="rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                        ...
                        <div class="border-b border-slate-200 px-6 py-5 dark:border-slate-800">
                            ...
                            <p class="mt-1 text-sm text-slate-500 dark:text-slate-400">
                                Define the SKU, pricing, and availability for this variant.
                            </p>
                        </div>
                        ...
                        <div class="space-y-6 px-6 py-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    @else
                                                border-slate-300 bg-white text-slate-900 focus:border-slate-500 focus:ring-slate-500 dark:border-slate-700 dark:bg-slate-950 dark:text-white
                                            @enderror"
                                />
                                ...
                                @else
                                    <p class="mt-2 text-xs text-slate-500 dark:text-slate-400">
                                        The SKU must be unique across all product variants.
                                    </p>
                                    @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input
                                            ...
                                            wire:model="price"
                                            placeholder="0.00"
                                            class="block w-full rounded-lg border border-slate-300 bg-white py-2.5 pl-8 pr-3 text-sm text-slate-900 shadow-sm outline-none transition focus:border-emerald-500 focus:ring-emerald-500 dark:border-slate-700 dark:bg-slate-950 dark:text-white"
                                    />
                                </div>
                            ...
                            <div class="rounded-lg border border-slate-200 bg-slate-50 p-4 dark:border-slate-800 dark:bg-slate-950">
                                <label class="flex cursor-pointer items-start gap-3">
                                    <input
                                            type="checkbox"
                                            wire:model="isActive"
                                            class="mt-0.5 h-4 w-4 rounded border-slate-300 accent-emerald-600 focus:ring-emerald-500 dark:border-slate-600"
                                    />
                        ...
                        <div class="flex flex-col-reverse gap-3 border-t border-slate-200 px-6 py-5 sm:flex-row sm:justify-end dark:border-slate-800">
                            ...
                            <button
                                    ...
                                    wire:target="save"
                                    class="inline-flex items-center justify-center gap-2 rounded-lg bg-emerald-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-emerald-500 dark:hover:bg-emerald-400"
                            >
                                <svg
                                        wire:loading
                                        wire:target="save"
                    ...
                    <div class="space-y-5 px-6 py-6">
                        ...
                        <div class="flex gap-3">
                            <div class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-400">
                                <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.8" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622C17.176 19.29 21 14.591 21 9c0-1.048-.133-2.065-.382-3.016z" />
                                </svg>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="mt-1 text-xs leading-5 text-slate-500 dark:text-slate-400">
                                    Active variants can participate in selling flows.
                                </p>
                            </div>
                        </div>
                ...
                <div class="rounded-xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
                    ...
                    <div class="px-6 py-6">
                        <div class="space-y-3 text-sm">
                            ...
                            <div class="flex items-center justify-between">
                                <span class="text-slate-500 dark:text-slate-400">Store</span>
